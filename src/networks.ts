import { RippleNetwork, RippleUrl } from './models';
...
const networks = {
  ...
  [RippleNetwork.MainnetFullHistory1]: {
  ...
  [RippleNetwork.MainnetFullHistory2]: {
