...
export function requestBookOffersBidsResponse(request: BookOffersRequest) {
  const options = {
...
export function requestBookOffersBidsPartialFundedResponse(
  request: BookOffersRequest,
  options: { gets: TakerAmount; pays: TakerAmount }
) {
  _.defaults(options, {
    gets: {
      currency: 'BTC',
...
export function requestBookOffersAsksPartialFundedResponse(
  request: BookOffersRequest,
  options: { gets: TakerAmount; pays: TakerAmount }
) {
  _.defaults(options, {
...
export function requestBookOffersAsksResponse(request: BookOffersRequest) {
  const options = {
    gets: request.taker_gets,
    pays: request.taker_pays,
  };
...
export function requestBookOffersXRPBaseResponse(request: BookOffersRequest) {
  return {
    id: request.id,
    status: 'success',
    type: 'response',
...
export function requestBookOffersXRPCounterResponse(request: BookOffersRequest) {
  return {
    id: request.id,
    status: 'success',
    type: 'response',
